...
class MetricsCalculator:
    ...
    def calculate_reach_velocity(
        self, 
        impressions_over_time: List[int], 
    ...
    def calculate_all_metrics(self, content_data: Dict[str, Any]) -> ViralityMetrics:
        ...
        engagement_rate = self.calculate_engagement_rate(likes, shares, comments, impressions)
        ...
        impressions_timeline = content_data.get("impressions_timeline", [0, impressions])
        time_intervals = content_data.get("time_intervals", [1.0])  # Default 1 hour
        reach_velocity = self.calculate_reach_velocity(impressions_timeline, time_intervals)
...
class BenchmarkMetrics:
    ...
    def compare_to_benchmark(self, metrics: ViralityMetrics) -> Dict[str, Dict[str, float]]:
        ...
        comparison["virality_coefficient"] = {
            ...
            "ratio": metrics.virality_coefficient / self.viral_benchmarks["virality_coefficient"]
        }
        ...
        comparison["reach_velocity"] = {
            ...
            "ratio": metrics.reach_velocity / self.viral_benchmarks["reach_velocity"] if self.viral_benchmarks["reach_velocity"] > 0 else 0
        }
        ...
        if metrics.completion_rate is not None:
            comparison["completion_rate"] = {
                ...
                "ratio": metrics.completion_rate / self.viral_benchmarks["completion_rate"]
            }
