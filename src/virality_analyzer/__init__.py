...
from .analysis import ContentClusterAnalyzer, DiagnosticEngine, ViralContentBenchmark
from .core import (
    ContentData,
    ContentMetrics,
    ContentType,
...
from .models import CausalAnalyzer, FeatureProcessor, ModelExplainer, ViralityPredictor
...
class ViralityAnalyzer:
    ...
    def train(
        self,
        training_data: List[ContentData],
        viral_examples: Optional[List[ContentData]] = None
    ) -> "ViralityAnalyzer":
    ...
    def benchmark(self, content_data, category=None):
        ...
        return self.diagnostic_engine.benchmark.benchmark_content(
