...
try:
    ...
    print("Warning: FAISS not available. Similarity search will use basic implementation.")

from sentence_transformers import SentenceTransformer
from sklearn.metrics.pairwise import cosine_similarity
from sklearn.preprocessing import StandardScaler

from ..core.models import ContentData, BenchmarkResult
...
class ViralContentBenchmark:
    ...
    def find_similar_viral_content(
        ...
        if FAISS_AVAILABLE and self.faiss_index is not None:
            ...
            similarities = 1 - distances[0]  # Since we're using L2 on normalized vectors
    ...
    def analyze_viral_patterns(self, category: Optional[str] = None) -> Dict[str, Any]:
        ...
        if category:
            content_to_analyze = [
                vc for vc in self.viral_content_db 
                if vc.platform.value == category or 
                   vc.content_type.value == category
            ]
