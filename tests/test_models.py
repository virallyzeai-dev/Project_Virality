...
from virality_analyzer.models import ViralityPredictor, FeatureProcessor, CausalAnalyzer
...
class TestModelIntegration:
    ...
    def test_predictor_training_flow(self):
        ...
        # Train the model
        training_result = predictor.train(content_data_list, validation_split=0.3, perform_cv=False)
