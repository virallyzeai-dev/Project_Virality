...
def main():
    ...
    print("   In practice, you need hundreds/thousands of examples for good performance\n")
    ...
    try:
        ...
        print("This is expected with minimal sample data. In practice, use real historical data.\n")
        return
    ...
    for i, content in enumerate(training_data, 1):
        ...
        try:
            ...
            print(f"Prediction: {'🚀 VIRAL' if prediction.is_viral_prediction else '📉 Non-Viral'}")
